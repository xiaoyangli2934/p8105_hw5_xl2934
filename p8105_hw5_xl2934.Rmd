...
The sample average of beta_2_hat for which the null is rejected is higher than true value of beta_2 while the beta_2_hat for all datasets is approximately eaqul to true value of beta_2.